...
const HomeScreen = () => {
  ...
  const { photos, loading, search, result, nextPage, prevPage, cont, fecthImagesPrevPage, fecthImagesNextPage, fecthImages } = useImagesPexel();
  ...
  return (
    <View
      ...
      <Text
        className='p-2 text-xs font-semibold text-gray-700 text-right'
      >
